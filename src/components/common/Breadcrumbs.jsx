...
const RUTAS = [
  ...
  { step: 7, label: "Reglas del colegio con IA", path: "/reglas-ia", group: "horarios" },
  { step: 8, label: "Panel de reglas", path: "/restricciones-panel", group: "horarios" },
  { step: 9, label: "Horario General", path: "/horario", group: "horarios" },
  { step: 10, label: "Horario por Docente", path: "/horario-docente", group: "horarios" },
  { step: 11, label: "Crear Usuario", path: "/admin/usuarios/crear", group: "admin" },
  { step: 12, label: "Gestion de Cuentas", path: "/admin/cuentas", group: "admin" },
  { step: 13, label: "Gestion de Docentes", path: "/admin/docentes", group: "admin" },
  { step: 14, label: "Bitacora de Auditoria", path: "/admin/auditoria", group: "admin" },
];
